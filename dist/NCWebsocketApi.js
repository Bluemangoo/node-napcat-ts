...
export class NCWebsocket extends NCWebsocketBase {
     ...
     * 获取自定义表情详情
     */
    fetch_custom_face_detail(params) {
     ...
     * 取消群相册媒体点赞
     */
    cancel_group_album_media_like(params) {
